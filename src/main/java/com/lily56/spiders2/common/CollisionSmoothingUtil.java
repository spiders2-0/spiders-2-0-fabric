...
public class CollisionSmoothingUtil {
	...
	@Nullable
	public static Pair<Vec3d, Vec3d> findClosestPoint(List<Box> boxes, Vec3d pp, Vec3d pn, float smoothingRange, float planeSmoothingRange, float boxScale, float dx, int iters, float threshold, Vec3d p) {
		if(boxes.isEmpty()) {
			return null;
		}
	...
	@Nullable
	private static Pair<Vec3d, Vec3d> findClosestPoint(float[] erx, float[] ery, float[] erz, float[] ecx, float[] ecy, float[] ecz, int count, Vec3d pp, Vec3d pn, float smoothingRange, float planeSmoothingRange, float dx, int iters, float threshold, Vec3d p) {
